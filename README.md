...
## Installation
 ...
 'npm i' Initiate the database with 'mysql -u root -p', then 'source db/schema.sql' Exit the mysql terminal 'npm run seed' to seed the data into your tables. Now you can run 'npm start'